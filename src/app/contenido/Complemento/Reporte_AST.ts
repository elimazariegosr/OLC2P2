...
import { Arreglo_3d, Get_Arreglo_3d, Set_Arreglo_3d } from '../Instrucciones/Arreglo_3d';
import { Concat } from '../Instrucciones/Concat';
import { Char_At } from '../Instrucciones/Char_At';
import { To_Lower_Case } from '../Instrucciones/To_Lower_Case';
import { To_Upper_Case } from '../Instrucciones/To_Upper_Case';
...
class Reporte_AST{
    ...
    sentencias_ast(sent):any{
        ...
        }else if(sent instanceof Arreglo_3d){
        ...
        }else if(sent instanceof Set_Arreglo_3d){
      ...
      sd_arreglo_ast(sent: Set_Arreglo_3d){
      ...
      gd_arreglo_ast(sent: Get_Arreglo_3d){
      ...
      pos_arreglo_ast(pos: Array<Object>){
        let i = 1;  
      ...
      ast(element):any{
        ...
        if(element instanceof Aritmetica || element instanceof Logica || element instanceof Relacional){     
          ...
          let e = new Nodo_AST("E",null,[hijo]); 
          return e;
        }else if(element instanceof Get_Arreglo_3d){
          ...
          let hijo1 = this.ast(element.exp1);
          let hijo2 = this.ast(element.exp2);
          let t = new Nodo_AST("Concat",null,[hijo1, hijo2]);
          let e = new Nodo_AST("E",null,[t]); 
          return e;
        
        }else if(element instanceof Char_At){
          let hijo1 = this.ast(element.expresion);
          let hijo2 = this.ast(element.posicion);
          let t = new Nodo_AST("Char At",null,[hijo1, hijo2]);
          let e = new Nodo_AST("E",null,[t]); 
          return e;
          
        }else if(element instanceof To_Lower_Case){
          let hijo1 = this.ast(element.expresion);
          let t = new Nodo_AST("To Lower Case",null,[hijo1]);
          let e = new Nodo_AST("E",null,[t]); 
          return e;
          
        }else if(element instanceof To_Upper_Case){
          let hijo1 = this.ast(element.expresion);
          let t = new Nodo_AST("To Upper Case",null,[hijo1]);
          let e = new Nodo_AST("E",null,[t]); 
          return e;
