...
class Arbol{
    ...
    etiquetas_inicio: Array<string>;
    etiquetas_return: Array<string>;
    tmp_return: Array<string>;
    pila_funcion: Array<Funcion>;
    return_principal :string;
    tabla_global: Tabla;
    funciones_extra:string;
    funciones_cabecera:string;
    constructor(instrucciones: Array<Nodo>, errores: Array<Errror>) {// inizializacion de attributos
        ...
        this.etiquetas_fin = [];
        this.etiquetas_inicio = [];
        this.etiquetas_return = [];
        this.tmp_return = [];
        this.pila_funcion = [];
        this.contador_tmp = 9;
        this.contador_p  = 0;
        this.cont_etiqueta = 0;
        this.contenido = "";
        this.return_principal = "";
        this.funciones_extra = "";
        this.funciones_cabecera = "";
        this.tabla_global = null;
