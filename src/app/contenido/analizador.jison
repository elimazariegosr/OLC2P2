...
PARAMETRO    :    ID { $$ = new Declaracion("let",null, $1, null, this._$.first_line,this._$.first_column);}
             ...
             |    ID DOS_PUNTOS TIPO C_ABRE C_CIERRA    
               /*PONER ARREGLOS AQUI*/ 
...
DECLARACION     :     ID DOS_PUNTOS TIPO { $$ = new Declaracion(tipo_dec,$3, $1, null,this._$.first_line,this._$.first_column);}
                |     ID DOS_PUNTOS TIPO IGUAL EXPRESION { $$ = new Declaracion(tipo_dec,$3, $1, $5,this._$.first_line,this._$.first_column);}
                
                |     ID DOS_PUNTOS TIPO IGUAL CONT_ARREGLO  {$$ = new Arreglo_3d($1,$3, $5, 0,null,0,0);}
                |     ID DOS_PUNTOS TIPO TIPO_ARREGLO IGUAL CONT_ARREGLO  {$$ = new Arreglo_3d($1,$3, $6, $4,null,0,0);}                   
                |     ID DOS_PUNTOS TIPO TIPO_ARREGLO IGUAL TK_NEW ARRAY P_ABRE EXPRESION P_CIERRA {$$ = new Arreglo_3d($1,$3, [], $4,$9,0,0);}                   
                |     ID DOS_PUNTOS TIPO IGUAL TK_NEW ARRAY P_ABRE EXPRESION P_CIERRA {$$ = new Arreglo_3d($1,$3, [], 1,$8,0,0);}                   
;          
...
ASIGNACION    :    ID IGUAL EXPRESION {$$ = new Asignacion($1,$3,this._$.first_line,this._$.first_column);}
              ...
              |    ID IGUAL TK_NEW TK_ARRAY P_ABRE EXPRESION P_CIERRA {$$ = new Asig_Arreglo_3d($1,[], $6,0,0);}    
              |    ID IGUAL CONT_ARREGLO {$$ = new Asig_Arreglo_3d($1,$3,null,0,0);}
;                   
/******************************************* FIN ASIGNACION VAR ******************************************/
...
GD_ARREGLO    :   ID LIST_D_ARREGLO {$$ = new Get_Arreglo_3d($1, $2,0,0);}
;
SD_ARREGLO    :   ID LIST_D_ARREGLO IGUAL EXPRESION P_COMA {$$ = new Set_Arreglo_3d($1, $2, $4,0,0);}
;
