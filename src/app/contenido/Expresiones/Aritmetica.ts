...
class Aritmetica extends Nodo{
        ...
        if(this.nodo_derecho != null){
            if(this.operador == '+'){
                ...
                if(this.es_numero()){
                    ...
                    }else if(this.nodo_derecho.tipo.type == tipos.BOOLEAN){ 
                            arbol.contenido += "\nt2 = " + resultado_der + ";"
                            arbol.contenido += "\nboolean_cadena();";
                            arbol.contenido += "\n" + this.numero_a_heap(-1, arbol);
                    }else{
                ...
                if(this.es_numero()){
                    this.tipo = new Tipo(tipos.NUMBER);
                    arbol.contenido += "\nt" + arbol.contador_tmp + " = fmod("+ resultado_izq + ", " + resultado_der + ");";
                    return "t" + arbol.contador_tmp;
            ...
            if(this.operador == '-'){
                ...
                if(this.nodo_izquierdo.tipo.type == tipos.NUMBER || this.nodo_izquierdo.tipo.type == tipos.BOOLEAN){
                    this.tipo = new Tipo(tipos.NUMBER);
    ...
    es_numero(){
        if((this.nodo_izquierdo.tipo.type == tipos.NUMBER && 
            this.nodo_derecho.tipo.type == tipos.NUMBER )|| (this.nodo_izquierdo.tipo.type == tipos.BOOLEAN && 
            this.nodo_derecho.tipo.type == tipos.NUMBER) || (this.nodo_izquierdo.tipo.type == tipos.NUMBER && 
                this.nodo_derecho.tipo.type == tipos.BOOLEAN) || (this.nodo_izquierdo.tipo.type == tipos.BOOLEAN && 
