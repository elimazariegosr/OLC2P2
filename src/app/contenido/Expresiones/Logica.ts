...
class Logica extends Nodo{
    ...
    traducir(tabla: Tabla, arbol: Arbol){
        if(this.nodo_derecho != null){
            ...
            let e_si_o = arbol.generar_etiqueta();
            let e_no_o = arbol.generar_etiqueta();
            let e_fin_o = arbol.generar_etiqueta();
            let e_si_o1 = arbol.generar_etiqueta();
            let e_no_o1 = arbol.generar_etiqueta();
            ...
            if(this.operador == '&&'){
                if (this.nodo_izquierdo.tipo.type == tipos.BOOLEAN &&
                        ...
                        arbol.contenido += "\n//--------- Logica && --------";
                        arbol.contenido += "\nif(" +resultado_izq + ") goto " + e_si_o + ";";
                        arbol.contenido += "\ngoto " + e_no_o + ";"; 
                        arbol.contenido += "\n" + e_si_o + ":";
                        arbol.contenido += "\nif(" +resultado_der + ") goto " + e_si_o1 + ";";
                        arbol.contenido += "\ngoto " + e_no_o1 + ";"; 
                        arbol.contenido += "\n" + e_si_o1 + ":";
                        arbol.contenido += "\n" + tmp + " = 1;";
                        arbol.contenido += "\ngoto " + e_fin_o + ";"; 
